...
// mongoose.connect("mongodb://localhost/truckRequestDB", {
...
app.post(
  ...
  [
    ...
    checkDuplicateRegistrationMiddleware,
  ],
...
app.post(
  ...
  [
    redirectIfNotAuthenticatedMiddleware,
    validateDeliveryDateMiddleware,
    checkDuplicateBolNoMiddleware,
  ],
...
app.get(
  "/delete-request/:_id",
  [redirectIfNotAuthenticatedMiddleware, checkSubmittedUserIdMiddleware],
...
app.get(
  "/confirm-shipping/:_id",
  [redirectIfNotAuthenticatedMiddleware, validateAdminMiddleware],
  confirmShippingController
);
...
app.post(
  ...
  [
    redirectIfNotAuthenticatedMiddleware,
    checkSubmittedUserIdMiddleware,
    validateDeliveryDateInModifyMiddleware,
    countAndFindDuplicateBolNoMiddleware,
  ],
...
app.post(
  "/update-destination/:_id",
  redirectIfNotAuthenticatedMiddleware,
  updateExistingDestinationController
);
...
app.post(
  ...
  [
    redirectIfNotAuthenticatedMiddleware,
    compareCurrentAndNewPasswordMiddleware,
    confirmNewPasswordMiddleware,
  ],
